 ...
 * На это поле в классе должен быть конструктор, get и set методы.
 * Также, у Человека должен быть метод printInfo(), который выводит в консоль информацию о человеке в формате:
...
public class Task1 {
    public static void main(String[] args) {
        Student student = new Student("Olga", "Journalism");
        Teacher teacher = new Teacher("Keanu Reeves", "Cinema");
