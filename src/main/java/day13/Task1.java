 ...
 *в поле ON должна быть дата создания объекта класса Message
 ...
 Методы:
 public static void sendMessage(User u1, User u2, String text) - этот метод “отправляет” новое сообщение от пользователя u1 пользователю u2 с текстом text. Отправка в нашем контексте означает добавление сообщения в нашу “базу данных”.
...
public class Task1 {
    public static void main(String[] args) {
        ...
        User user_1 = new User("Аня");
        User user_2 = new User("Маша");
        User user_3 = new User("Егор");

        user_1.sendMessage(user_2, "Привет");
        user_1.sendMessage(user_2, "Сегодня едем, как и договаривались?");
        user_2.sendMessage(user_1, "Привет");
        user_2.sendMessage(user_1, "Да, все в силе");
        user_2.sendMessage(user_1, "жду");
        user_3.sendMessage(user_1, user_1.getUsername() + ", я с вами!");
        user_3.sendMessage(user_1, "где встречаемся");
        user_3.sendMessage(user_1, "?");
        user_1.sendMessage(user_3, "Супер!");
        user_1.sendMessage(user_3, "в том же месте");
        user_1.sendMessage(user_3, "в тот же час");
        user_3.sendMessage(user_1, "ok)");
